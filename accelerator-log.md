...
```json
{
  "applicationName" : "tap-steeltoe-web-app",
  "projectName" : "tap-steeltoe-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [Sample->tap-steeltoe-web-app]
...
┃ ┃ ┃ ┃ ┗ ┗ Debug Path 'Sample.csproj' matched '^(?<folder>.*/)?(?<filename>([^/]+?|)(?=(?<ext>\.[^/.]*)?)$)' with groups {ext=.csproj, folder=null, filename=Sample.csproj, g0=Sample.csproj, g1=null, g2=Sample.csproj, g3=Sample.csproj, g4=.csproj} and was rewritten to 'tap-steeltoe-web-app.csproj'
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->tap-steeltoe-web-app, sample-app->tap-steeltoe-web-app]
